...
class PowerSwitch extends React.Component {
    ...
    touchMove(e) {
        const deltaX = (e.changedTouches[0].clientX - this.state.start.x) * 2.3704
        const deltaY = (e.changedTouches[0].clientY - this.state.start.y) * 2.3704
